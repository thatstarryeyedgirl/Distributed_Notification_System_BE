...
class APIKeyAuthenticationMiddleware:
    def __init__(self, get_response):
        ...
        self.authorized_services = {
            ...
            'template_service': os.getenv('TEMPLATE_SERVICE_KEY', 'template_key_12345')
        }
    ...
    def __call__(self, request):
        ...
        if calling_service and provided_api_key:
                ...
                return JsonResponse(
                    {
                        "success": False,
                        "error": "unauthorized", 
                        "message": f"Service '{calling_service}' is not authorized to access user service"
                    }, 
                    status=401
                )
            ...
            print(f"✅ Authorized request from {calling_service} to user service")
