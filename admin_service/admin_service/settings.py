...
USER_SERVICE_URL = os.getenv('USER_SERVICE_URL', 'http://localhost:8001/api/v1')

# API Keys
API_GATEWAY_KEY = os.getenv('API_GATEWAY_KEY')
USER_SERVICE_KEY = os.getenv('USER_SERVICE_KEY')
TEMPLATE_SERVICE_KEY = os.getenv('TEMPLATE_SERVICE_KEY')
EMAIL_SERVICE_KEY = os.getenv('EMAIL_SERVICE_KEY')
PUSH_SERVICE_KEY = os.getenv('PUSH_SERVICE_KEY')
